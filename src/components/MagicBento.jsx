...
const DEFAULT_GLOW_COLOR = '203, 108, 230'; // Embryo Purple (CB6CE6) as RGB
...
export const BentoCard = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = e => {
      ...
      if (enableTilt) {
        const rotateX = ((y - centerY) / centerY) * -3; // reduced tilt for larger editorial cards
      ...
      if (enableMagnetism) {
        const magnetX = (x - centerX) * 0.015; // very subtle magnetism
  ...
  return (
    ...
    >
      {enableStars && <div className="particle-container" style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}></div>}
      {children}
    </div>
  );
};
...
const GlobalSpotlight = ({
  ...
  useEffect(() => {
    ...
    spotlight.style.cssText = `
      ...
      mix-blend-mode: multiply; /* changed to multiply for light theme */
    `;
